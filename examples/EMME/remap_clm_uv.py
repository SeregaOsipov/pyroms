...
def remap_clm_uv(src_file, src_grd, dst_grd, cdepth=0, kk=0, dst_dir='./', irange=None, jrange=None):
    ...
    src_uz = pyroms_toolbox.Grid_GLORYS.flood_fast(src_varu, src_grd, spval=spval, cdepth=cdepth, kk=kk)
    src_vz = pyroms_toolbox.Grid_GLORYS.flood_fast(src_varv, src_grd, spval=spval, cdepth=cdepth, kk=kk)
