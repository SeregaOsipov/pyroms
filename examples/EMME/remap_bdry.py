...
def remap_bdry(src_file, src_varname, src_grd, dst_grd, cdepth=0, kk=2, dst_dir='./', irange=None, jrange=None):
    ...
    if ndim == 3:
        ...
        src_varz = pyroms_toolbox.Grid_GLORYS.flood_fast(src_var, src_grd, spval=spval, cdepth=cdepth, kk=kk)
    else:
